    ...
    <article className="bg-[#ffffff] border border-[#e5ded0] rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-200 flex flex-col justify-between">
      <div>
        ...
        <div className="p-6">
          ...
          {/* Matriz de Precios */}
          <div className="bg-[#f7f4ed] p-3.5 rounded-xl border border-[#e5ded0] grid grid-cols-3 gap-2 text-center text-xs mb-4">
            <div>
              <p className="text-[10px] text-[#5a524c] uppercase font-semibold">Entre Semana</p>
              <p className="font-bold text-[#d95d39] text-sm">${room.priceWeekday} MXN</p>
            </div>
            <div>
              <p className="text-[10px] text-[#5a524c] uppercase font-semibold">Fin de Semana</p>
              <p className="font-bold text-[#2d2926] text-sm">${room.priceWeekend} MXN</p>
            </div>
            <div>
              <p className="text-[10px] text-[#5a524c] uppercase font-semibold">Temp. Alta</p>
              <p className="font-bold text-[#2d2926] text-sm">${room.priceHighSeason} MXN</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 pt-0">
        <Link
          ...
          className="block w-full text-center bg-[#2d2926] hover:bg-[#d95d39] text-[#ffffff] font-semibold py-3 rounded-xl transition-colors text-sm shadow-sm"
        >
          Reservar Habitación
        </Link>
      </div>
