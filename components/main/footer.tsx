      ...
      <section className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 items-start">
          ...
          <div className="space-y-4 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            {/* Iconos Redes con aria-label corregidos */}
            <div className="flex gap-3 text-[#2d2926]/70 pt-2">
              <a 
                href="https://www.instagram.com/hotel_santafe_chignahuapan/!" 
                target="_blank" 
                rel="noopener noreferrer" 
                aria-label="Instagram de Hotel Santa Fe Chignahuapan" 
              ...
              <a 
                href="https://www.facebook.com/HotelSantaFeChignahuapan/" 
                target="_blank" 
                rel="noopener noreferrer" 
                aria-label="Facebook de Hotel Santa Fe Chignahuapan" 
                className="hover:text-[#d95d39] transition-colors"
              >
              ...
              <a 
                href="https://www.tiktok.com/@hotelsantafe47" 
                target="_blank" 
                rel="noopener noreferrer" 
                aria-label="TikTok de Hotel Santa Fe Chignahuapan" 
                className="hover:text-[#d95d39] transition-colors"
              >
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-[#2d2926]/80">
              ...
              <li><Link href="/guia-turistica" className="hover:text-[#d95d39] transition-colors">Guía Turística</Link></li>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-[#2d2926]/80">
              <li><Link href="/terminos-y-condiciones" className="hover:text-[#d95d39] transition-colors">Términos y Condiciones</Link></li>
